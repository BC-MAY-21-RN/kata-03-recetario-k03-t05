          ...
          <View style={styles.topContainer}>
            ...
            >
              <TouchableHighlight onPress={() => navigation.goBack()}>
                <Icon style={styles.icons} name="close" color="white" />
              </TouchableHighlight>
              <View style={{ flexDirection: "row" }}>
                <Icon style={styles.icons} name="share" color="white" />
                <Icon style={styles.icons} name="favorite" color="white" />
              </View>
            </View>
            <View>
